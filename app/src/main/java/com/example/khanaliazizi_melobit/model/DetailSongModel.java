...
public class DetailSongModel
{
    ...
    public com.example.khanaliazizi_melobit.model.album getAlbum() {
        return album;
    }

    public void setAlbum(com.example.khanaliazizi_melobit.model.album album) {
        this.album = album;
    }
    ...
    public com.example.khanaliazizi_melobit.model.audio getAudio() {
        return audio;
    }

    public void setAudio(com.example.khanaliazizi_melobit.model.audio audio) {
        this.audio = audio;
    }
